...
public class OpenSimplex2STest {
    ...
    public void noise2_isCorrect(){
        ...
        double[] noise = openSimplex2S.noise2(points, points.length/2);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise2_timing(){
        ...
        for (int c = 0; c < numTests; c++) {
            OpenSimplex2S openSimplex2S = new OpenSimplex2S(c);
            double[] noise = openSimplex2S.noise2(points, points.length/2);
        }
    ...
    public void noise2XBeforeY_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise2XBeforeY(points, points.length/2);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise3Classic_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise3Classic(points, points.length/3);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise3XYBeforeZ_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise3XYBeforeZ(points, points.length/3);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise3XZBeforeY_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise3XZBeforeY(points, points.length/3);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise4Classic_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise4Classic(points, points.length/4);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise4XYBeforeZW_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise4XYBeforeZW(points, points.length/4);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise4XZBeforeYW_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise4XZBeforeYW(points, points.length/4);
        assertNotNull(noise);
        stopMethodTracing();
    }
    ...
    public void noise4XYZBeforeW_isCorrect(){
        ...
        OpenSimplex2S openSimplex2S = new OpenSimplex2S(1234);
        double[] noise = openSimplex2S.noise4XYZBeforeW(points, points.length/4);
        assertNotNull(noise);
        stopMethodTracing();
    }
}